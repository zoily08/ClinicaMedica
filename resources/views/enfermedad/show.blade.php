...
<div  style=" background-color:#f2f2f1 " >
    ...
    <legend  style="width: inherit;padding:inherit;border:2px solid silver;" class="legend" align= "center"  size="6" face="Comic Sans MS,arial,verdana" color="0e4743"><div style="color: #112b56"  ><B>Información  de la Enfermedad</B></div></legend>
    <div class="container" > 
        <br>
        ...
        <div class="modal-footer">
            <div class="col-lg-10 col-sm-10 col-md-10 col-xs-12">
                ...
                <a href="{{URL::action('EnfermedadController@index',$enf->idenfermedad)}}"><button type="button" class="btn btn-danger"><span class="fa fa-retweet" aria-hidden="true" > Regresar</span></button></a>
            </div>
        </div>
    </fieldset>
 </div>   