    ...
    <div class="modal-dialog">
        <div class="modal-content"> 
            <div style="background-image: url({{asset ('img/100.jpg')}});" class="modal-header">
                            ...
                            <font  size="6" face="Comic Sans MS,arial,verdana" color="0e4743"><p align="center">Editar Especialidad</p></font>
                                @if (count($errors)>0)  
            ...
            {!! Form::model($especialidad,['route'=>['especialidad.update',$especialidad->idespecialidad],'method'=>'PATCH','autocomplete'=>'off']) !!}
            ...
            <strong>
                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                    <div class="form-group">
                        <label for="nombre">(*) Nombre de la Especialidad:</label><div class="input-group margin-bottom-sm"><span class="input-group-addon"><i class="fa fa-building"></i></span>
                        <input type="text" name="nombre" required value="{{$especialidad->nombre}}" class="form-control"  onkeyup="vNom(this)" onkeypress="return soloLetras(event)"  placeholder="Nombren Especialidad">
                        </div>
                    </div>
                </div>
