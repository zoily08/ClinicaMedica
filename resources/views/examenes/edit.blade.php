<div class="modal fade" id="modal-exam-edit">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            'placeholder' => 'Precio del Examen','id'=>'price_exam_edit']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            ['class'=>'form-control','min'=> '0','step'=>'.01', 'placeholder' => 'Tipo de Examen','id'=>'type_exam_edit']) !!}
                                        </div>
                                    </div>
