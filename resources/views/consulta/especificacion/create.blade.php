@foreach($especificacion as $espe) 
	<div data-backdrop="static" class="modal" id="modal-especificacion-create-{{$espe->idpaciente}}"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="overflow-y: scroll;">
                ...
                <div class="form-group">
                  <label for="idpaciente">Paciente</label>
                    <div class="input-group margin-bottom-sm">
                      ...
                      <option value="{{$espe->idpaciente}}"> {{$espe->nombre_p}} {{$espe->apellido_p}} </option></label>
                    </div>
                </div>
              </div>
              <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
