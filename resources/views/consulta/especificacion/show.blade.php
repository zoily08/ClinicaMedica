 ...
 <br>
	...
	<div  style=" background-color:#f2f2f1 " >
			...
			<div class="modal-footer">
			 ...
			 <a href="{{ route('paciente.pdf') }}"><button type="button"  class="btn btn-success" style="color: #003366; background-color: #e7fffe" ><span class="fa fa-download"> IMPRIMIR LISTADO DE SIGNOS</span></button>
