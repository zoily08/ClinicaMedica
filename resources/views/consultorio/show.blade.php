...
<div  style=" background-color:#f2f2f1 " >
	...
	<div class="container" > 
		...
		<div class="modal-footer">
			...
			<a href="{{URL::action('ConsultorioController@index',$consultorio->idconsultorio)}}"><button type="button" class="btn btn-danger"><span class="fa fa-retweet" aria-hidden="true" > Regresar</span></button></a>
		</div>
	</div>
</fieldset>
</div>  
