          ...
          <table  class="table table-striped table-bordered table-condensed table-hover" style="text-align:center;">
             ...
             <thead style="background-color:#1c779e">
                        ...
                        <!--<th style="text-align:left">
                         <font color="white">ID</font></th>-->

                        <th style="text-align:left">
                         <font color="white">ROLE</font></th>

                         <th style="text-align:left">
                         <font color="white">DESCRIPCIÓN </font></th>
                    ...
                    <tbody>
                      ...
                      <td width="10px"> 
                         @can('roles.show')
                            <a href="{{ route('roles.show', $role->id) }}"> <button type="button" class="btn btn-Secondary "><span class="fa fa-eye"></span></button>
