         ...
         <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
          ...
          <div class="input-group margin-bottom-sm">
            <span class="input-group-addon"><i class="fa fa-phone-square fa-fw"></i></span>
               <input  onkeypress="return soloNumero(event)" onpaste="return false" maxlength="8" type="text" name="telefono_p" value="{{$pa->telefono_p}}" class="form-control" placeholder="numero de telefono del paciente...">
            </div>
         </div>
         </div>
